...
#include <Tools/Console/CommandNode.h>
#include <Math/Math.h>
...
namespace Flux {
    ...
    String::String(const char *str) {
        ...
        // Allocate our data.
        this->data = Allocator<char>::alloc(capacity);

        // Copy the string.
        Allocator<char>::copy(str, str + size, this->data);
    ...
    String::String(const char *mem, size_t limit) {
        ...
        // Copy the string.
        Allocator<char>::copy(mem, mem + limit, this->data);
    ...
    String &String::operator=(Array<char> const &other) {
        ...
        if (!other.data) {
            ...
            this->data = Allocator<char>::alloc(other.capacity);

            // Copy the array contents.
            Allocator<char>::copy(other.data, other.data + other.size, this->data);
    ...
    String &String::operator=(Array<char> &&other) noexcept {
        ...
        if (other.getAt(other.size - 1) != '\0') {
            ...
            if (other.size >= other.capacity) {
                ...
                Allocator<char>::realloc(data, capacity, other.size + 1);
    ...
    String String::operator+(const char* other) const {
        ...
        String str;
        str.resize(this->getSize() + len);

        Memory::copy(data, data + getSize(), str.data);
        Memory::copy(other, other + len, str.data + getSize());
    ...
    bool String::validateFormat(const String &format) {

        Int openBraceIndex = -1;
        Int index = 0;

        for (char const& e : format) {
            switch (e) {
                case '{':
    ...
    Array<size_t> String::getArgIndices(const String &string) {
